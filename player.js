    ...
    return this.client({
      '/player/main.js': function(){
        ...
        doPlay = function(){
          ...
          endpoint = (ref$ = $('script[src*="/apps/ethercalc/socket.io/socket.io.js"]')) != null ? (ref1$ = ref$.attr('src')) != null ? ref1$.replace(/\.?\/socket.io\/socket.io.js.*/, '') : void 8 : void 8;
          if (endpoint === '') {
          ...
          if ((ref$ = window.Drupal) != null && ref$.sheetnode) {
            ...
            try {
              if (!SocialCalc.CurrentSpreadsheetControlObject) {
                window.history.pushState({}, '', "/apps/ethercalc/" + SocialCalc._room + (function(){
                  switch (false) {
          ...
          if (endpoint) {
            this$.connect(null, {
              resource: endpoint.replace(/\/?$/, '/apps/ethercalc/socket.io').replace(/^\//, '')
            });
          } else {
            this$.connect();
          }
          ...
          return this$.on({
            data: function(){
              ...
              case 'stopHuddle':
                ...
                window.location = '/apps/ethercalc/';
              }
            }
          });
        };
        ...
        onLoad = function(ssInstance){
          ...
          return $(document).on('click', '#te_fullgrid tr:nth-child(2) td:first', function(){
            return window.open("/apps/ethercalc/" + SocialCalc._room + ".html");
          });
        };
